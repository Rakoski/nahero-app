...
import 'package:flutter_app_helio/paginas/cidade/cidade_lista_page.dart';

class CidadeFormPage extends StatefulWidget {
  final Map<String, dynamic>? cidadeParaEditar;
  final bool? taEditando;

  CidadeFormPage({Key? key, this.cidadeParaEditar, this.taEditando})
    : super(key: key);

  @override
  _CidadeFormPageState createState() => _CidadeFormPageState();
}
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) =>
                            taEditando == true
                                ? CidadeListaPage()
                                : CidadeListaPage(cidade: novaCidade),
                  ),
                );
              },
